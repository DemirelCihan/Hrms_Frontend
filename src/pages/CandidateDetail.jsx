                    ...
                    <Grid.Row>
                      <Grid.Column>
                        ...
                        <Button
                          ...
                          content="Favorites"
                          as={NavLink}
                          to={`/candidates/candidate/${resume.candidate?.id}/favoriteJobPostings`}
                        />
                        {resume.image == null ? (
                          <Image
                            circular
                            size="small"
                            src="https://res.cloudinary.com/merveucer/image/upload/v1631964376/user_ckfrbd.svg"
                          />
                        ) : (
                          <Image
                            circular
                        ...
                        {resume.languageLevels.length === 0 ? null : (
                          <Segment raised>
                            <Header
                              as="h5"
                              content="Languages"
                            ...
                            {resume.languageLevels.map((languageLevel) => (
                              <span>
                                <LanguageLevelIcons
                                  level={languageLevel.level?.level}
                                />
                                &nbsp;&nbsp;
