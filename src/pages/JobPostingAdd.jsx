                ...
                <Form onSubmit={formik.handleSubmit}>
                  ...
                  <Form.Group widths="equal">
                    <Form.Select
                      ...
                      onChange={(event, data) =>
                        handleChange("workingTime", data.value)
                      }
                    ...
                    <Form.Select
                      ...
                      onChange={(event, data) =>
                        handleChange("workingType", data.value)
                      }
                          ...
                          formik.touched.workingTime && (
                            <span>
                              <Label
                                ...
                                color="pink"
                                className="orbitron"
                                content={formik.errors.workingTime}
                              />
                              <br />
                              <br />
                            </span>
                  ...
                  <Form.Group widths="equal">
                    <Form.Input
                      ...
                      placeholder="1"
                      onChange={(event, data) =>
                        handleChange("numberOfOpenPositions", data.value)
                      }
